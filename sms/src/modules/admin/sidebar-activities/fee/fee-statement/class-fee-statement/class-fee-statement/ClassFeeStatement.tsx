...
export default function ClassFeeStatement() {
  return (
    <>
      ...
      <form className="sm:grid-cols-2  lg:grid-cols-3 xl:grid-cols-4 ring-1 ring-black ring-opacity-5 form-solid grid grid-cols-1 gap-4 p-4 my-6 mb-12 rounded-md shadow">
        <div className="">
