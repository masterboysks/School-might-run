...
const countries = {
    ...
    district(country, province) {
        return countryAPI.get(`/get-districts?country_id=${country}&province_id=${province}`);
    },
    municipality(country, province, district) {
        return countryAPI.get(`/get-municipalities?country_id=${country}&province_id=${province}&district_id=${district}`);
    },
};
