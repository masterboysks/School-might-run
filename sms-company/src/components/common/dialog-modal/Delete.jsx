        ...
        (value?.value?.inUse ? (
          ...
          >
            <Transition.Child
              ...
              leaveTo="opacity-0"
            >
              <div className="fixed inset-0 z-[99999] bg-gray-500 bg-opacity-75 transition-opacity" />
            </Transition.Child>
            ...
            <div className="fixed inset-0 z-[999999] overflow-y-auto">
              <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                ...
                >
                  <Dialog.Panel className="relative transform w-full overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-lg transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
