...
export default function Filter() {
    ...
    return (_jsx(_Fragment, { children: _jsxs("form", { className: "sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 ring-1 ring-black ring-opacity-5 form-solid grid grid-cols-1 gap-4 p-4 my-2 mb-6 rounded-md shadow ", children: [_jsx("div", { className: "", children: _jsx(Select, { label: "Level*", value: arrayLevel, selected: level, setSelected: setLevel }) }), _jsx("div", { className: "", children: _jsx(Select, { label: "Class/Semester*", value: arrayClassSemester, selected: classSemester, setSelected: setClassSemester }) }), _jsx("div", { className: "", children: _jsx(Select, { label: "Faculty", value: arrayFaculty, selected: faculty, setSelected: setFaculty }) }), _jsx("div", { className: "", children: _jsx(Select, { label: "Section*", value: arraySection, selected: section, setSelected: setSection }) })] }) }));
}
