...
const AddGuardianFalse = () => {
    ...
    return (_jsx("div", { className: "sm:ml-[72px] box-border md:ml-0 md:w-full sm:pt-2 md:min-w-0 flex-1z", children: _jsx("div", { className: " absolute left-0 w-full top-28 sm:mt-9 md:block sm:static -z-10 ", children: _jsxs("div", { className: "-z-10 w-11/12 mx-auto text-sm ", children: [_jsx(AboveForm, { steps: steps, title: "Local Guardian details" }), _jsx(GuardianFormFalse, {})] }) }) }));
};
