...
const ReportSlidebar = () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { className: "w-[216px]  mt-[2px] box-border text-primary-grey-600 border-r-[1px] z-[99] border-r-primary-grey-100-grey-200 bg-primary-grey-100 fixed top-16 md:static   ml-[72px] md:ml-0 h-[94vh] pb-20 overflow-y-auto hidden lg:inline ", id: "slidebar", children: _jsx("div", { className: "w-full", children: _jsxs("ul", { className: "pt-9 mx-2", children: [_jsxs("li", { id: "attendanceReport", onClick: () => {
              ...
              ${attendanceReport
                   ...
                   ${attendanceReport && !dropAttendanceReport
                                    ? "bg-primary-grey-200 "
                                    : "text-primary-grey-600"}text-sm`, children: [_jsx("div", { id: "arrow", className: `devList text-black  transition duration-100 ease-in text-sm ${dropAttendanceReport ? "rotate-90" : ""}  `, children: _jsx(Arrow, { fontSize: "sm" }) }), _jsx("div", { className: " text-sm", children: "Attendance report" })] }), _jsx("ul", { className: `${dropAttendanceReport ? "" : "hidden"} transition duration-700 ease-in`, id: "dropdown", children: links.map((curr) => {
                                ...
                                }) }), _jsx(Link, { to: "exam-report", onClick: sidebar, children: _jsxs("li", { className: ` flex p-1   pr-3    mt-2 mb-3 cursor-pointer rounded  ${location.includes("/report/exam-report")
                                        ? " bg-primary-grey-200  text-primary-grey-700 "
                                        : " hover:bg-primary-grey-200 text-primary-grey-600 "} text-sm`, children: [_jsx("div", { className: "devList text-primary-grey-300", children: _jsx(Arrow, { fontSize: "sm" }) }), "Exam report"] }) }), _jsx(Link, { to: "fee-report", onClick: sidebar, children: _jsxs("li", { className: ` flex p-1  pr-3    mt-2 mb-3 cursor-pointer rounded ${location.includes("/report/fee-report")
                                        ? " bg-primary-grey-200  text-primary-grey-700 "
                                        : " hover:bg-primary-grey-200 text-primary-grey-600 "} text-sm`, children: [_jsx("div", { className: "devList text-primary-grey-300", children: _jsx(Arrow, { fontSize: "sm" }) }), "Fee report"] }) }), _jsx(Link, { to: "topper-report", onClick: sidebar, children: _jsxs("li", { className: ` flex p-1   pr-3   mt-2 mb-3 cursor-pointer rounded ${location.includes("/report/topper-report")
                                        ? " bg-primary-grey-200  text-primary-grey-700 "
                                        : " hover:bg-primary-grey-200 text-primary-grey-600 "} text-sm`, children: [_jsx("div", { className: "devList text-primary-grey-300", children: _jsx(Arrow, { fontSize: "sm" }) }), "Topper report"] }) })] }) }) }), _jsx("div", { className: " sm:ml-[72px] box-border md:ml-0 sm:pt-2 md:w-full  md:min-w-0 flex-1", children: _jsx("div", { className: "top-28 sm:mt-9 md:block sm:static -z-10 absolute left-0 w-full", children: _jsx("div", { className: "-z-10 sm:mt-9 w-11/12 mx-auto text-sm", children: _jsx(Outlet, {}) }) }) }), _jsx("div", { className: "lg:hidden overscroll-none opacity-95 fixed top-0  z-[99999] left-[288px] hidden w-full h-screen bg-transparent", id: "overlay", onClick: sidebar })] }));
};
