...
const Slidebar = () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { className: "min-w-[216px]  mt-[2px] box-border text-primary-grey-600 border-r-[1px] z-[99] border-r-primary-grey-100-grey-200 bg-primary-grey-100 fixed top-16 md:static   ml-[72px] md:ml-0 h-[94vh] pb-20 overflow-y-auto hidden lg:inline ", id: "slidebar", children: _jsx("div", { className: "w-full", children: _jsxs("ul", { className: "pt-9 mx-2", children: [_jsx(Link, { to: "/teacher/dashboard/lms/assignment", onClick: sidebar, children: _jsxs("li", { className: ` flex p-1   pr-3    mt-2 mb-3 cursor-pointer rounded  ${location.includes("/teacher/dashboard/lms/assignment")
                                        ? " bg-primary-grey-200  text-primary-grey-700 "
                                        : " hover:bg-primary-grey-200 text-primary-grey-600 "} text-sm`, children: [_jsx("div", { className: "devList text-primary-grey-300", children: _jsx(Arrow, { fontSize: "inherit" }) }), "Assignment"] }) }), _jsx(Link, { to: "/teacher/dashboard/lms/e-libary", onClick: sidebar, children: _jsxs("li", { className: ` flex p-1 mt-2   pr-3   mb-3 cursor-pointer rounded ${location.includes("/teacher/dashboard/lms/e-libary")
                                        ? " bg-primary-grey-200  text-primary-grey-700 "
                                        : " hover:bg-primary-grey-200 text-primary-grey-600 "} text-sm`, children: [_jsx("div", { className: "devList text-primary-grey-300", children: _jsx(Arrow, { fontSize: "inherit" }) }), "E-Library"] }) }), _jsx(Link, { to: "/teacher/dashboard/lms/pratice-questions", onClick: sidebar, children: _jsxs("li", { className: ` flex p-1 mt-2 mb-3  pr-3    cursor-pointer rounded ${location.includes("/teacher/dashboard/lms/pratice-questions")
                                        ? " bg-primary-grey-200  text-primary-grey-700 "
                                        : " hover:bg-primary-grey-200 text-primary-grey-600 "} text-sm`, children: [_jsx("div", { className: "devList text-primary-grey-300", children: _jsx(Arrow, { fontSize: "inherit" }) }), "Pratice questions"] }) }), _jsxs("li", { id: "data", onClick: () => {
              ...
              ${data ? "text-primary-grey-700" : "text-primary-grey-600"} 
                   ${data && !dropReports
                                    ? "bg-primary-grey-200 "
                                    : "text-primary-grey-600"}text-sm`, children: [_jsx("div", { id: "arrow", className: `devList text-black  transition duration-100 ease-in text-sm ${dropReports ? "rotate-90" : ""}  `, children: _jsx(Arrow, { fontSize: "inherit" }) }), _jsx("div", { className: " text-sm", children: "Reports" })] }), _jsx("ul", { className: `${dropReports ? "" : "hidden"} transition duration-700 ease-in`, id: "dropdown", children: links.map((curr) => {
